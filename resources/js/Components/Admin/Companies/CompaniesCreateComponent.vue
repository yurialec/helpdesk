    ...
    <div class="container-fluid px-2">
        <div class="card shadow-sm">
            <div class="card-header bg-light">
                <h5 class="mb-0">
                    {{ step === 1 ? 'Cadastrar Empresa' : 'Cadastrar Sistemas da Empresa' }}
                </h5>
            </div>
            <!-- LINHA DE ETAPAS -->
                    ...
                    <div class="col-12 col-md-8 col-lg-6">
                        ...
                        <div v-if="step === 2">
                            ...
                            <form @submit.prevent="addSystem" autocomplete="off">
                                ...
                                <button type="submit" class="btn btn-primary btn-sm ms-auto mt-2">
                                    <i class="bi bi-plus-lg"></i> Adicionar
                                </button>
                            </form>

                            <!-- LISTA DE SISTEMAS ADICIONADOS -->
                            <div class="mt-4">
                                <h6 class="text-muted mb-2">Sistemas adicionados:</h6>
    ...
    methods: {
        ...
        addSystem() {
            ...
            if (!this.system.description) {
                this.alertDanger('Informe a descrição do sistema.');
                return;
            }
        ...
        save() {
            axios.post('/admin/companies/store', this.company)
                .then(() => {
        ...
        clearForm() {
            this.company = { name: '', cnpj: '', email: '', phone: '', address: '' };
            this.systems = [];
            this.system = { name: '', description: '', category_id: '' };
            this.validEmail = this.validCnpj = this.validPhone = null;
        },
    }
}
</script>
